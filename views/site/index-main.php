			...
			<section class="navbar navbar-fixed-top custom-navbar" role="navigation">
				<div class="container">
					<div class="navbar-header">
						...
						<a href="#" class="navbar-brand"><?= Html::img(Url::to('@web/img/sea-logo-white.png'), ['class' => 'navbar-brand', 'style' => 'width:270px; height: 150px;']) ?></a>
					</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12 col-sm-12">
							...
							<h3 style="color:#00695c">PANEL DE CONTROL</h3>
							<h1 style="color:#00695c">TICKETS LERCO</h1>
							<hr>
