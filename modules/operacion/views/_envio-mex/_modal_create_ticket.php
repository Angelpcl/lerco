...
<div class="fade modal " id="modal-create-ticket"  tabindex="-1" role="dialog" aria-labelledby="modal-show-label" >
                ...
                <div class="col-lg-8 col-md-7 col-sm-7">
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">Información ticket</h3>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <?= Html::button('<i class="fa fa-search"></i> Buscar', ['id' =>'btn_search_envio','class' => 'btn  btn-primary btn-small', "style" => "margin-top: 20px;", 'type' => 'button'] ) ?>
                                        </div>
                                    </div>
                            ...
                            <div class="div_search_envio" style="display: none">
                               <div class="panel">
                                    <div class="panel-body text-center">
                                        <?= Html::img('@web/img/profile-photos/compras.png', ["class" => "img-md img-circle mar-btm", "alt" => "Paqueteria la Cora"]) ?>
