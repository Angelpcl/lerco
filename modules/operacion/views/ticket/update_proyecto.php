...
<div class="operacion-ticket-form">
                ...
                <div class="ibox-content">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                                ...
                                <?= $form->field($model, 'nombre')->textInput()->label("Nombre del proyecto") ?>
                                <?= $form->field($model, 'descripcion')->textInput()->label("¿En que consiste este proyecto?") ?>
    ...
    <div class="form-group">
        <?= Html::submitButton($model->isNewRecord ? 'Crear Proyecto' : 'Guardar cambios', ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary', 'id' => 'btnGuardarTicket']) ?>
