...
<div class="operacion-envio-tierra-index">
    <div class="btt-toolbar">

        <?= Html::hiddenInput('tipo_envio', Envio::TIPO_ENVIO_TIERRA) ?>
    ...
    $(document).ready(function(){
         var  $filters = $('.btt-toolbar :input'),
            ...
            actions = function(value, row) { return [
                ...
                (can.delete_basic? '<a href="<?= $bttUrlDelete ?>' + row.id + '" title="Cancelar envio" class="fa fa-trash" data-confirm="Confirma que deseas cancelar el envio" data-method="post"></a>': '')
            ].join(''); },
            columns = [
                {
                    field: 'id',
            ...
            params = {
                id      : 'envio',
                element : '.operacion-envio-tierra-index',
                url     : '<?= $bttUrl ?>',
                colorAdeudo  : true,
