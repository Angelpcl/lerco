                    ...
                    <div class="ibox-content">
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <?= $form->field($model, 'pais_id')->textInput([
                                            'value' => $model->pais ? $model->pais->nombre : '',
                            ...
                            <div class="col-md-4 text-center">
                                <?php if (isset($model->pais->imagen) && !empty($model->pais->imagen)) : ?>
                                    <?= Html::img('@web/uploads/flags/' . $model->pais->imagen, ['alt' => 'Bandera', 'class' => 'img-flag', 'id' => 'img-avatar']) ?>
                                <?php else : ?>
