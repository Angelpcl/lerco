...
$this->title = 'Reporte de cobros USA';
...
<div class="reportes-cobros-index">
    <div class="btt-toolbar">
        ...
        <?= Html::hiddenInput('is_cobro_mex', true) ?>
        <div class="row">
            <div class="col-sm-9">
                   ...
                   <div class="panel-heading">
                    ...
                    <div id="toolbar-panel-collapse" class="collapse in" aria-expanded="false">
                        <div class="panel-body pad-btm-15px">
                            ...
                            <?= Html::label("por sucursal", "agrupar-sucursal", ["style" => "display:inline"]) ?>

                            <?= Html::checkbox("agrupar[tipo_envio]", false, ["id" => "agrupar-tipo_envio", "class" => "magic-checkbox"]) ?>
                            <?= Html::label("por tipo de servicio", "agrupar-tipo_envio", ["style" => "display:inline"]) ?>

                            <?= Html::checkbox("agrupar[metodo_pago]", false, ["id" => "agrupar-metodo_pago", "class" => "magic-checkbox"]) ?>
                            <?= Html::label("por metodo de pago", "agrupar-metodo_pago", ["style" => "display:inline"]) ?>

                            <?= Html::checkbox("agrupar[viaje]", false, ["id" => "agrupar-viaje", "class" => "magic-checkbox"]) ?>
                            <?= Html::label("por viaje", "agrupar-viaje", ["style" => "display:inline"]) ?>
