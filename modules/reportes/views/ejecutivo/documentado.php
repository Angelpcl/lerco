...
$this->title = 'Documentados - Almacen';
				                    ...
				                    <div>
			                     	...
			                     	<div class="mar-top">
				                        <strong class="pad-rgt">Agrupar:</strong>
				                            ...
				                            <?= Html::label("Por egreso", "agrupar-viaje", ["style" => "display:inline"]) ?>

				                            <?= Html::checkbox("agrupar[agente]", false, ["id" => "agrupar-agente", "class" => "magic-checkbox"]) ?>

				                            <?= Html::label("Por agente", "agrupar-agente", ["style" => "display:inline"]) ?>

				                            <?= Html::checkbox("agrupar[reembolso]", false, ["id" => "agrupar-reembolso", "class" => "magic-checkbox"]) ?>

				                            <?= Html::label("Por reembolso", "agrupar-reembolso", ["style" => "display:inline"]) ?>*/?>
				                    </div>
				                </div>
				            </div>
				        </div>
					...
					<div class="panel">
						<div class="panel-heading">
			                <div class="panel-control">
			                    <ul class="nav nav-tabs">
							        ...
							        <li>
							            <a data-toggle="tab" href="#tab-documentado">Documentado</a>
							        </li>
							        <li>
					    ...
					    <div class="tab-content">
					        <div id="tab-index" class="tab-pane fade active in">
					            <?= $this->render('_dashboard_documentado') ?>
					        </div>
					        <div id="tab-documentado" class="tab-pane fade">
					        	<?= $this->render('_reporte_documentado') ?>
				            </div>
