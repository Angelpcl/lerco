                ...
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <?= $form->field($user, 'cliente_razon_social')->dropDownList(
                                    ClienteRazonSocial::getClientesList(),  // Aquí se usan los proyectos con el formato adecuado
                                    [
                                        'prompt' => 'Selecciona el cliente',
                                        'id' => 'proyecto-dropdown',
                                        //'value' => $model->proyecto,
                                    ]
                                )->label("Selecciona la razon social de este usuario:"); ?>
                            ...
                            <?php // $form->field($user, 'bodega_descarga_asignado')->dropDownList(DescargaBodega::$descargaList,['prompt' => '']); ?>
                        </div>
                        <div class="col-lg-6">
                            <div class="row">
                                <div class="col-sm-5">
                ...
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            [
                                'language' => 'es',
                                    'value' => isset($user->sucursal_id)  && $user->sucursal_id ? [$user->sucursal->id => $user->sucursal->clave ." ". $user->sucursal->nombre] : [],
