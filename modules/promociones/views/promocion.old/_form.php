        ...
        <div class="col-lg-10">
            <div class="panel">
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Información de promoción</h3>
                </div>
                                ...
                                <ul class="row wz-step wz-icon-bw wz-nav-off mar-top">
                                    <li class="col-xs-4">
                                        <a data-toggle="tab" href="#demo-main-tab1">
                                            ...
                                            <h5 class="mar-no">Promociónes Genericas / Reulizables</h5>
                                        </a>
                                    </li>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <table class="table table-striped">
                                                            <thead>
                                                                <tr>
                                                                    <th>Libras (requeridas)</th>
                                                                    <th>Costo de libra con ID </th>
                                                                    <th>Costo de la libra sin ID</th>
                                                                    <th>Complemento</th>
                                                                    <th>Acciones</th>
                                                                </tr>
                                                            </thead>
     ...
     <table>
        <tbody class="template_promocion">
            <tr id = "promocion_id_{{promocion_id}}">
                ...
                <td ><?= Html::input('number', "", false,["class" => "form-control" ,"style" => "text-align:center", "id"  => "table_cos_con_code", "step"=>".01"]) ?></td>
...
$(document).ready(function() {
    ...
    $btnAgregarPromocion.click(function(){
        ...
        promocion = {
            ...
            "costo_libra_sin_code" : $form_promocion_detalle.$cos_sin_code.val(),
            "costo_libra_code"     : $form_promocion_detalle.$cos_con_code.val(),
            "lb_requerida"         : $form_promocion_detalle.$lb_requerida.val(),
        ...
        if (promocion.promocion_id == $ele_promocion_detalle_id ){
            ...
            switch(inputChange){
                case 'LIBRA_REQUERIDA':
                    promocion.lb_requerida = $ele_promocion_val.val();
                break;
                case 'COS_CON_CODE':
                    promocion.costo_libra_code = $ele_promocion_val.val();
                break;
                case 'COS_SIN_CODE':
                    promocion.costo_libra_sin_code = $ele_promocion_val.val();
                break;
