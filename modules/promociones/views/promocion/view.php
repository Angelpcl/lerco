...
<p>
    ...
    <?= $can['update'] && $can['create'] ?
        '<button  type="button"  data-target="#modal-promocion" data-toggle="modal"  class="modal-create btn btn-purple btn-lg add " ><i id="icon_emisor" class="fa fa-gift mar-rgt-5px icon-lg"></i> Activar promoción</button>'
    : '' ?>
...
<?= $this->render('_modal_edit_promocion', [
    'model' => $model,
]) ?>
