...
<div class="pagos-pago-form">
    ...
    <?php $form = ActiveForm::begin(['id' => 'form-egreso' ]) ?>
        ...
        <div class="col-lg-7">
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <?= $form->field($model, 'concepto_id')->dropDownList(EsysListaDesplegable::getItems('concepto_pago'), ['prompt' => 'Selecciona el concepto']) ?>
                            <?= $form->field($model, 'tipo')->dropDownList(PagoGasto::$tipoList) ?>
    ...
    <div class="form-group">
        <?= Html::submitButton($model->isNewRecord ? 'Crear egreso' : 'Guardar cambios', ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>
