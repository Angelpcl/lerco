                ...
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <?= $form->field($model, 'tipo')->dropDownList(Sucursal::$tipoList) ?>
                            <?= $form->field($model, 'costo_libra')->textInput(['type' => 'number',"step" => ".01"]) ?>
                        </div>
                        <div class="col-lg-6">
        ...
        <div class="col-lg-5">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-sm-12">
                            <?= $form->field($model, 'origen')->dropDownList(Sucursal::$origenList)->label(false); ?>
                        </div>
                    </div>
                </div>
            </div>
