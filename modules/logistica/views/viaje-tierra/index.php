...
$bttUrl       = Url::to(['viajes-tierra-json-btt']);
...
<p>
    <?= $can['create']?
        Html::a('Nuevo viaje para carga de trailer', ['create'], ['class' => 'btn btn-success add']): '' ?>
</p>

<div class="logistica-viaje-tierra-index">
    <div class="btt-toolbar">
        <?= Html::hiddenInput('tipo_servicio', Envio::TIPO_ENVIO_TIERRA) ?>
    </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        var can     = JSON.parse('<?= json_encode($can) ?>'),
            ...
            params = {
                id      : 'viajeTierra',
                element : '.logistica-viaje-tierra-index',
                url     : '<?= $bttUrl ?>',
                bootstrapTable : {
                    columns : columns,
