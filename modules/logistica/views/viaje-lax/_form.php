...
<div class="logistica-viaje-lax-form">
    <?php $form = ActiveForm::begin(['id' => 'form-viaje-lax' ]) ?>
    <div class="row">
        <div class="col-lg-7">
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <?= $form->field($model, 'placas')->textInput(['maxlength' => true])->label('Serie o Clave') ?>

                            <?= $form->field($model, 'nombre_chofer')->textInput(['maxlength' => true])->label("Nombre de aerolinea") ?>
