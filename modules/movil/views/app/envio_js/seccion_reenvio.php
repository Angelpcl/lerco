...
$btnAddRenvio.click(function(){
    ...
    $cliente_receptor.val().length && renvio_array.length > 0 ? $('.next', $content_tab).show() :   $('.next', $content_tab).hide();
...
var load_reenvio_select = function(){
    ...
    $reenvio_select_id.append("<option value='0'>Selecciona reenvío</option>");
