                ...
                if (p_complemento.length > 0 ) {
                    $.each(p_complemento,function(key,item){
                        ...
                        if (!isNaN(parseInt(key))) {
                            ...
                            $("#table-lbfree_check",$tr).html(item.is_lb_free == 10 ? "<i class='fa fa-check-square-o' aria-hidden='true'></i>" + "<p>" + item.lb_free + " USD</p>" : "<i class='fa fa-times' aria-hidden='true'></i>");
