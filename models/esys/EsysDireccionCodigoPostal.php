...
class EsysDireccionCodigoPostal extends \yii\db\ActiveRecord
{
    ...
    {
        $params['codigo_postal'] = array_key_exists('codigo_postal', $params)? $params['codigo_postal']: NULL;
        $params['estado_id']     = array_key_exists('estado_id', $params)? $params['estado_id']: NULL;
        $params['municipio_id']  = array_key_exists('municipio_id', $params)? $params['municipio_id']: NULL;
        ...
        if(isset($params['codigo_postal']) && $params['codigo_postal'])
            $EsysDireccionCodigoPostal->andWhere(['codigo_postal' => $params['codigo_postal']]);

        if(isset($params['estado_id']) && $params['estado_id'])
            $EsysDireccionCodigoPostal->andWhere(['estado_id' => $params['estado_id']]);

        if(isset($params['municipio_id']) && $params['municipio_id'])
